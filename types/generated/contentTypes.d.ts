...
export interface ApiFooterFooter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    copyright_label: Attribute.String;
    dynamicZone: Attribute.DynamicZone<
      ['footer.footer-section', 'footer.icon', 'footer.link']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPagePublicPagePublic extends Schema.CollectionType {
  collectionName: 'page_publics';
  info: {
    singularName: 'page-public';
    pluralName: 'page-publics';
    displayName: 'Page Public';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiProjectMemberProjectMember extends Schema.CollectionType {
...
export interface ApiShowShow extends Schema.CollectionType {
  ...
  attributes: {
    ...
    venue_url: Attribute.String;
    location: Attribute.String;
    location_url: Attribute.String;
    ticket_url: Attribute.String;
    isPassed: Attribute.Boolean & Attribute.DefaultTo<false>;
    isCanceled: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::page-public.page-public': ApiPagePublicPagePublic;
